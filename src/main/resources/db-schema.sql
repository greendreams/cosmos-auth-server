...
('role_admin'),('role_user'),('role_manager'),('role_hr');
...
INSERT INTO PERMISSION_ROLE (PERMISSION_ID, ROLE_ID) VALUES
(1,3), /* can_create_user assigned to role_manager */
(2,3), /* can_update_user assigned to role_manager */
(3,3), /* can_read_user assigned to role_manager */
(4,3), /* can_delete_user assigned to role_manager */
(3,4);  /* can_read_user assigned to role_hr */
...
'admin-do-not-reply@cosmoncluster.com',1,0,0,0),
('karthik','{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi',
'karthik@cosmoncluster.com',1,0,0,0),
('vidhya','{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi',
'vidhya@cosmoncluster.com',1,0,0,0),
('sanjay','{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi',
'sanjay@cosmoncluster.com',1,0,0,0);
...
(3, 2) /* role_user assigned to user user */,
(4, 3) /* role_admin assigned to admin user */,
